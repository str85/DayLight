...
![DayLight schema](http://i.imgur.com/SXURt4n.png)
...
Все компании в DayLight публичны. Торги акциями происходят на внутренней децентрализованной бирже. Акции можно наделить различными привилегиями. Что именно дают различные привилегии описывается в программном коде внутри LightDay.
