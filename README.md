...
Если в [Настройках параметров государства](#Настройка-параметров-государства) выбрана многпартийная форма власти, тогда любой гражданин достигший определнного в парметрах возраста может создать свою партию.
